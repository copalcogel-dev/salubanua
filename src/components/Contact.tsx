    ...
    <section id="contact" className="bg-[#f6f4ee] py-28">
      <div className="mx-auto max-w-5xl px-6 lg:px-10">
        ...
        >
          ...
          <h2 className="mb-14 text-4xl font-semibold text-[#1f4d38] sm:text-5xl">
            {t.contact.title}
          </h2>
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-3">
            <div className="rounded-2xl border border-black/10 bg-white p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
              <MapPin size={22} strokeWidth={1.5} className="mb-4 text-[#2fa86a]" />
              <p className="mb-2 text-[11px] font-semibold uppercase tracking-[0.2em] text-[#1f4d38]/60">
                {t.contact.addressLabel}
              </p>
              <p className="text-sm leading-relaxed text-[#1f4d38]">
            ...
            <div className="rounded-2xl border border-black/10 bg-white p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
              <Users2 size={22} strokeWidth={1.5} className="mb-4 text-[#2fa86a]" />
              <p className="mb-2 text-[11px] font-semibold uppercase tracking-[0.2em] text-[#1f4d38]/60">
            ...
            <div className="rounded-2xl border border-dashed border-black/20 bg-white/60 p-6">
              <Phone size={22} strokeWidth={1.5} className="mb-4 text-[#1f4d38]/40" />
              <p className="mb-2 text-[11px] font-semibold uppercase tracking-[0.2em] text-[#1f4d38]/60">
                {t.contact.phoneLabel}
              </p>
              <p className="text-sm leading-relaxed text-[#1f4d38]/60">
