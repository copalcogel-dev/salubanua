...
export function DiscoverVillage() {
  ...
  return (
    <section id="explore" className="relative overflow-hidden bg-[#163a2b] py-28">
      <div className="absolute inset-0 opacity-25">
        ...
        />
        <div className="absolute inset-0 bg-[#163a2b]/60" />
      </div>
      <div className="relative mx-auto grid max-w-7xl grid-cols-1 gap-14 px-6 lg:grid-cols-2 lg:px-10">
        ...
        >
          <p className="mb-4 text-[11px] font-semibold tracking-[0.3em] text-emerald-200/70">
            {t.discover.kicker}
          </p>
        ...
        >
          {t.discover.points.map((p, i) => {
            ...
            return (
              <div key={p.label} className="bg-[#163a2b] p-6">
                <Icon size={18} strokeWidth={1.5} className="mb-3 text-[#2fa86a]" />
                <p className="mb-1 text-[11px] font-semibold uppercase tracking-[0.2em] text-emerald-200/60">
                  {p.label}
                </p>
